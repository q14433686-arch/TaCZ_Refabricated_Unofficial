...
`0.7.0-forge1.1.8-hotfix`；本分支当前源码版本为 **`1.1.8+fabric.26.1.2.R3-hotfix2`**。
...
| Java | **25+** |
| Fabric API | **0.155.2+**；R3-hotfix2 构建使用 **0.155.2+26.1.2** |
| Forge Config API Port | **26.1.5+，硬依赖** |
| 本 mod | **`1.1.8+fabric.26.1.2.R3-hotfix2`** |
...
作为 SemVer 核心，`+fabric.26.1.2.R3-hotfix2` 是构建元数据，不参与 Fabric 的版本先后比较。
