...
| D3 | PIP / 第二世界镜内渲染 | ✅ **2026-08-23 更新**：已由 [PR #66](https://github.com/q14433686-arch/TaCZ_Refabricated_Unofficial/pull/66) 合并进 26.2 主线，实验性、默认关闭（开启教程与实验性声明见根目录 `README.md` §4.2）。「暂停」结论作废；「上游本无 PIP、放大靠 FOV 变焦」这一上游事实不变 |
