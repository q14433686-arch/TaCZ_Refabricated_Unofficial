...
- 9 mm、5.56×45、7.62×39、12G、.45 ACP、.308、5.7×28、5.8×42 的最终四物料装配由带独立槽位的 TACZ 弹药装配机完成；工作盆、置物台/传送带不再被要求推断多种 custom-NBT 输入；
- AK、AR、Glock、M1911、M9A4、MP5、UMP45、P90、FAL 的模板、机匣/枪身、枪机/套筒、枪管、击发组、复进组件已作为数据驱动 NBT 部件生产；
- `CREATE_FLY` 档会移除上述八种旧工作台散装弹配方；AK-47、M4A1、Glock 17、M1911、M9A4、MP5A5、UMP45、P90、FAL 的旧工作台成枪配方只有在对应的单工件 `create:sequenced_assembly` 工艺存在并通过校验后才会移除。
