...
| `lineage/SCOPE_TEXT_SHOW_1211_20260901.md` | 镜内 `text_show`（MK5/MK5HD 弹药计数）**从不显示**的根因与修法：`functionalTasks` 在瞄具深度孔径路径上没被 flush；三个文件的改动、与 26.1.2 补丁的两处差别、以及**尚未跑**的四格实机剧本（掩码开/关 × Iris 开/关 + PIP） |
