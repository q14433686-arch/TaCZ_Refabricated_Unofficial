...
Minecraft 26.2 R2 changelog and release notes. The registry is the supported downstream extension
point; synthetic lambda names and other compiler-generated methods are not API.
