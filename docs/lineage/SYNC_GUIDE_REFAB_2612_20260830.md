> **本文件是 26.2 线（`arena/01a04e96`，尖端 `01698440`）的副本**，2026-09-02 同步轮
> 随 `docs/lineage/` 目录制一起搬到 26.1.2 线，作为全家族同步的唯一索引在本分支留存。
> **内容未按 26.1.2 改写**：里面的分支进度底账是 08-31 的快照，26.1.2 线自己的最新状态
> 见 [`SYNC_ROUNDUP_2612_20260902.md`](SYNC_ROUNDUP_2612_20260902.md)。
> 后续维护：哪条线改了家族级结论，由那条线改，别在副本里另立一套。
