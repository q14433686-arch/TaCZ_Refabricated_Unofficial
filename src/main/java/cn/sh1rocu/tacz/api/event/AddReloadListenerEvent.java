...
public class AddReloadListenerEvent extends BaseEvent {
    ...
    private static class WrappedStateAwareListener implements PreparableReloadListener {
        ...
        @Override
        public CompletableFuture<Void> reload(final PreparableReloadListener.SharedState state, final Executor backgroundExecutor, final PreparableReloadListener.PreparationBarrier barrier, final Executor gameExecutor) {
