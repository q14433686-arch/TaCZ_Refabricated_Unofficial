...
public final class PapiManager {
     ...
     * {@code c9b8ba1} 与 26.2 的 {@code ec51f556}， lineage 见
     * {@code docs/lineage/SCOPE_TEXT_SHOW_1211_20260901.md} §5）</h2>
     ...
     * {@code I18n.language.getOrDefault(textKey)}）。1.21.11 侧对该成员做过 CI javap 探针核实；
     * 本分支与 1.21.11 同以 {@code net.minecraft.locale.Language} 为 {@code I18n.language} 的静态类型。</p>
     */
