    ...
    private static void resolve() {
        ...
        synchronized (CarryOnReflection.class) {
            ...
            try {
                ...
                GunMod.LOGGER.warn("Carry On compatibility could not resolve the audited 2.11.x data API (CarryOnDataManager#getCarryData(Player), CarryOnData#getBlock(), and CarryOnData#getBlockEntity(BlockPos, HolderLookup.Provider))", e);
            } finally {
                resolved = true;
            }
        }
