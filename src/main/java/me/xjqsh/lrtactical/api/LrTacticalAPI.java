 ...
 * LRTactical 的对外查询入口。
 *
 * <p>当前公开投掷物、近战、消耗品三类 index 查询，以及<b>同样三类</b>客户端
 * display 查询。历史：旧注释曾称“只暴露投掷物”，2026-08-12 复核更正；
 * 消耗品的 display 查询是 2026-08-27 同步官方 0.4.3 时才补上的
 * （此前只有 index，渲染通道缺失，见 {@code ConsumableDisplayInstance} 类注释）。
 */
