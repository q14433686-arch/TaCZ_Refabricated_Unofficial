...
// Scope body vertex shader — identical to vanilla core/entity.vsh.
// The actual mask logic is in scope_body.fsh. This file exists as a
// matching vsh for the custom pipeline.
